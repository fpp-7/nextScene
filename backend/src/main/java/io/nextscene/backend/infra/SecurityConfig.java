...
public class SecurityConfig {
     ...
     * em produção deve ser sobrescrito via APP_CORS_ALLOWED_ORIGINS.
     */
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Documentação da API. Some do ar em produção via
                // springdoc.*.enabled=false (SWAGGER_UI_ENABLED) — o matcher aqui
                // só importa quando ela está de fato ligada.
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // A autenticação é via header Bearer, não cookies — não há credenciais a compartilhar.
